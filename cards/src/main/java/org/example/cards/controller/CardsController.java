...
public class CardsController {
    ...
    private final CardsContactInfoData cardsContactInfoData;
    ...
    @Operation(
            ...
            description = "Get Java version that is used in accounts microservice",
            responses = {
                    @ApiResponse(
                            responseCode = "200",
                            description = "HTTP Status OK"
    ...
    public ResponseEntity<CardsContactInfoData> getContactInfo(){
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(cardsContactInfoData);
    }
